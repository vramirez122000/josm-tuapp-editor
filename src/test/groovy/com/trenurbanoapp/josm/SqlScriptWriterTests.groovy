 ...
 */
class SqlScriptWriterTests extends Specification {

    @Test
    def "test write"(filename) {
        setup:
        Main.pref = new Preferences()
        InputStream input = SqlScriptWriterTests.getResourceAsStream(filename)
        DataSet data = OsmReader.parseDataSet(input, null);
